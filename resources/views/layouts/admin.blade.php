...
<body class="dashboard-body">
  <header>
    ...
    <nav class="side-navigation">
      <a class="text-center pb-5 sidnav-brand">CrossWords</a>
      <ul class="nav-list">
        <li class="nav-item">
                    ...
                    <div class="account-info">
                      ...
                      <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                          <a class="dropdown-item dropdown-link" href="{{ route('admin.profile') }}"><i class="fas fa-user mr-2"></i>my profile</a>
                          <a class="dropdown-item dropdown-link" href="{{ route('home') }}"><i class="fas fa-home mr-2"></i>go to homepage</a>
                          <hr>
