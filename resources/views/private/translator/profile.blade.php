              ...
              <div class="row">
                <div class="col-md-8 col-sm-12">
                  <div class="welcome-text-box">
                    <h1 class="heading-one text-capitalize">hello {{ auth()->user()->first_name }}</h1>
                    <p>This is your profile page, You can see the progress you've made with you work and manage your projects or assigned tasks</p>
                  </div>
                </div>
              </div>
              <div class="row">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <form method="post" action="{{ route('translator.profileupdate') }}" autocomplete="off">
                              ...
                              <hr class="my-4" />
                              <form method="post" action="{{ route('translator.profilepassword') }}" autocomplete="off">
                                  @csrf
                                  @method('put')
                          ...
                          <div class="col-4">
                            <div class="d-flex justify-content-center">
                                <div>
                                    ...
                                    <button id="cancel" onclick="window.location.href='{{route('translatorprofile')}}'" style="display: none" class="close-button mt-2">cancel</button>
                                </div>

                                    <form id="profileform" style="display:none" action="{{ route('translatoruploadimage') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="account-details text-center">
                              ...
                              <span class="account-role text-capitalize">Translator</span>
