              ...
              <div class="row my-5">
                <div class="col-12">
                  <div class="actions">
                    <div class="row">
                      <div class="col-12">
                        <div class="title-button-container d-flex justify-content-between align-items-center py-5">
                          <h4 class="heading-four">Add Language</h4>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <form method="post" action="{{ route('languages.store') }}" enctype="multipart/form-data" autocomplete="off" >

                          @csrf
                          <div class="form-group">
                            <label for="titleInput" class="text-capitalize">language name</label>
                            <input type="text" class="@error('name') is-invalid @enderror form-control form-control-lg" placeholder="Type language name" name="name" value="{{ old('name') }}" autocomplete="name" required>
                          ...
                          <div class="d-flex justify-content-center mt-5">
                            <button type="submit" class="submit-button rounded">Submit</button>
                          </div>
                        </form>
                      </div>
                    </div>
