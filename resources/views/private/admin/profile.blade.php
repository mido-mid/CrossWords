                      ...
                      <div class="account-edit-profile">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <form method="post" action="{{ route('admin.profileupdate') }}" autocomplete="off">
                                @csrf
                                @method('put')
                              ...
                              <hr class="my-4" />
                              <form method="post" action="{{ route('admin.profilepassword') }}" autocomplete="off">
                                  @csrf
                                  @method('put')
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="account-details text-center">
                              ...
                              <span class="account-role text-capitalize">Admin</span>
